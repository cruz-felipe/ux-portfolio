...
export default function CaseLayout({ data }: { data: CaseStudyData }) {
  ...
  return (
    <>
      ...
      <main id="main-content" role="main" className="page-enter" style={{ background: "var(--white)", color: "var(--ink)", minHeight: "100vh" }}>
        ...
        {data.metrics.length > 0 && (
          <section className="metrics-section case-metrics" style={{ display: "grid", gridTemplateColumns: `repeat(${data.metrics.length}, 1fr)`, borderBottom: "0.5px solid var(--border)" }}>
        ...
        <section className="context-section" style={{ padding: "var(--space-lg) var(--pad)", borderBottom: "0.5px solid var(--border)" }}>
          <div className="case-context" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "var(--space-xl)", alignItems: "start" }}>
            <p style={{ fontFamily: "var(--font-body)", fontSize: "15px", fontWeight: 300, lineHeight: 1.82, color: "#333", margin: 0, textWrap: "pretty" }}>{cleanPara(data.context)}</p>
            {data.showNdaNote ? (
        ...
        <div ref={sectionsRef}>
          {data.sections.map((section, si) => (
            <div key={si}>
              ...
              {section.pullquote && (
                <div className="cs-pullquote-section">
              ...
              {(Array.isArray(section.body) ? section.body.length > 0 : !!section.body) && (
                <section className="case-section" style={{ padding: "var(--space-lg) var(--pad)", borderBottom: "0.5px solid var(--border)" }}>
                  ...
                  <div className="case-section-body" style={{ maxWidth: "var(--content)" }}>
