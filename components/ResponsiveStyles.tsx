export default function ResponsiveStyles() {
  return (
    <style>{`
      ...
      .case-section   { grid-template-columns: var(--sidebar) 1fr !important; }
      .artifact-caption {
        display: flex;
      ...
      @media (max-width: 900px) {
        ...
        .case-section   { grid-template-columns: 1fr !important; gap: 1.25rem !important; }
      ...
      @media (max-width: 680px) {
        ...
        /* Work */
        #work                         { padding: 3rem 1.25rem 4rem !important; }
        ...
        /* About */
        #about                      { padding: 3.5rem 1.25rem !important; }
        ...
        .screen-gallery-section { padding: 2rem 1.25rem !important; }
        ...
        /* Artifacts */
        .artifact-section       { padding: 2rem 1.25rem !important; }
        ...
        section[aria-label="More work"] { grid-template-columns: 1fr !important; gap: 1.5rem !important; }
